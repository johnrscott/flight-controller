...
The schematic diagram for the open-loop driver (i.e. no sensorless feedback) using these components is shown below.

.Schematic for the open-loop motor driver experiment
image::diagrams/schematic_simple_driver.png[width=50%]
